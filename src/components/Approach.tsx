      ...
      <div className="container-custom">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          <AnimatedSection animationType="slide-in-left" delay={0.2}>
            <div className="text-center p-6 rounded-lg shadow-md bg-asentica-beige-light/50 hover:shadow-lg transition-all duration-300 hover:-translate-y-2">
              <div className="inline-flex items-center justify-center w-16 h-16 rounded-full bg-gradient-to-br from-asentica-gold/30 to-asentica-gold/10 mx-auto mb-4 shadow-inner">
